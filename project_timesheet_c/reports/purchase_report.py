...
class EmployeePurchaseReport(models.Model):
    ...
    def _from(self):
        from_str = """
            ...
            purchase_order_line l
                join project_task po on (l.order_id=po.id)
    ...
    def read_group(self, domain, fields, groupby, offset=0, limit=None, orderby=False, lazy=True):
        ...
        res = []
        if fields:
            res = super(EmployeePurchaseReport, self).read_group(domain, fields, groupby, offset=offset, limit=limit, orderby=orderby, lazy=lazy)
